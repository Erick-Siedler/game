...
export const BOSS_RELICS=[
 ...
 relic('emergencyIrrigation','EMERGENCY IRRIGATION','Uma base em crise desperta todo o Garden.','Uma vez por Garden em cada run: ao cair abaixo de 30% HP, suas plantas regeneram 2% do HP máximo por segundo durante 8s.','relic',{threshold:.3,regenPerSecond:.02,duration:8},['garden','healing']),
