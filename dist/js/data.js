...
export const ZOMBIES=[
 ...
 {id:'sprinter',name:'Sprinter',role:'fast',roleLabel:'FAST',hp:155,speed:1.08,damage:18,attackInterval:.72,color:'#b5bd72',threatCost:1.75,unlockWave:4,weight:3.4,waveCap:18,groupCap:6,ability:'Corrida veloz.',description:'Chega ao jardim antes do restante da horda.'},
 {id:'brute',name:'Brute',role:'heavy',roleLabel:'HEAVY',hp:1150,speed:.29,damage:58,attackInterval:1.55,color:'#71836b',threatCost:8,unlockWave:8,weight:1.15,waveCap:6,groupCap:1,armorFlat:10,minDamageRatio:.12,ability:'Armadura improvisada.',description:'Reduz hits pequenos, mas ataques pesados atravessam sua defesa.'},
 {id:'sporekeeper',name:'Sporekeeper',role:'support',roleLabel:'SUPPORT',hp:420,speed:.42,damage:14,attackInterval:1.25,color:'#78976b',threatCost:4.5,unlockWave:11,weight:1.25,waveCap:2,groupCap:1,healRadius:2.6,healInterval:4.5,healPercent:.06,healCap:90,healMaxTargets:4,ability:'Pulso de esporos.',description:'Cura aliados próximos e deve ser eliminado cedo.'},
 {id:'volatile',name:'Volatile',role:'volatile',roleLabel:'EXPLODES',hp:260,speed:.53,damage:19,attackInterval:1.05,color:'#91a84f',threatCost:4,unlockWave:12,weight:1.5,waveCap:4,groupCap:2,deathRadius:1.3,deathDamage:120,ability:'Explosão tóxica.',description:'Ao morrer, fere plantas agrupadas ao redor.'}
];
